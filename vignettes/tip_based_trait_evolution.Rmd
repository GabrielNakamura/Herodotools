---
title: "Tip based metrics of trait evolution"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Tip based metrics of trait evolution}
...
```{r loadTraitData, echo=T,eval=TRUE}
...
```{r fig8, echo=FALSE,eval=TRUE,fig.cap="Maps with tip metrics of evolution dynamics of life mode for Sigmodontine species", fig.height= 3.5, fig.width=7}
mapTransition_rate
```
