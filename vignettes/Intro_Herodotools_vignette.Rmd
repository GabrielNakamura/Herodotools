...
you do not have the packages already installed, they will be installed using the following code.
...
Now we need to read the files corresponding to the distribution of species in assemblages of 1x1 cell degrees, and phylogenetic relationship that 
...
# Ancestral area reconstruction for Akodon species {#mergeMacroAssemblage} and in situ diversification metrics
