...
```{r outFig1, echo=FALSE, eval=TRUE, out.width="70%", fig.cap="Species richness for Akodon genus in South America"}
map_richness
```
...
```{r evoregion_calc, echo=TRUE, eval=TRUE}
regions <- 
...
```{r outFig2, echo=FALSE,eval=TRUE,out.width="70%",fig.cap="Evoregions for Akodon species communities"}
map_evoregion
```
...
```{r outFig3, echo=FALSE,eval=TRUE,out.width="70%",fig.cap="Evoregion and afilliation for communities of Akodon Genus"}
map_joint_evoregion_afilliation
```
