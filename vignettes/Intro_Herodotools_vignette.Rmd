...
```{r outFig1, echo=FALSE, eval=FALSE, out.width="70%"}
map_richness
```
...
```{r outFig2, echo=FALSE,eval=FALSE,out.width="70%"}
map_evoregion
```
...
sites <- bind_cols(site_xy, site_region =  site_region, afi)
...
```{r outFig3, echo=FALSE,eval=FALSE,out.width="70%"}
map_joint_evoregion_afilliation
```
