...
akodon_sites <- read.table(system.file("extdata", "Table_Akodon_coords_pa.txt", package = "Herodotools"), 
                           header = TRUE)
akodon_newick <- ape::read.tree(system.file("extdata", "akodon.new", package = "Herodotools"))
```
...
```{r outFig1, echo=FALSE, eval=FALSE, out.width="70%", fig.cap="Species richness for Akodon genus in South America"}
map_richness
```
...
```{r save_evoregion_calc, echo=FALSE, eval=FALSE}
...
```{r outFig2, echo=FALSE,eval=FALSE,out.width="70%",fig.cap="Evoregions for Akodon species communities"}
map_evoregion
```
...
```{r outFig3, echo=FALSE,eval=FALSE,out.width="70%",fig.cap="Evoregion and afilliation for communities of Akodon Genus"}
map_joint_evoregion_afilliation
```
...
```{r fig4_age, echo=FALSE, eval=FALSE}
...
```{r fig5_afilliation, echo=FALSE, eval=FALSE}
...
```
```{r outFig6, echo=FALSE,eval=FALSE,out.width="70"}
map_dispersion_from
```
...
#```
#
#```{r fig6_afilliation, echo=FALSE, eval=FALSE}
...
```{r fig6_PEdb, echo=FALSE, eval=FALSE}
