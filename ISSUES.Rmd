...
- [ ] remove 'DivB_metrics.R'

- [ ] change 'Herodotools/inst/extdata/resDEC_akodon.rds' to an '.RData' file. Or 
```
...
- [ ] add documentation for argument `age.no.ancestor` in 'function_age_arrival.R'.
