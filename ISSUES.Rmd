...
- [ ] Evoregions output in number and all other in Letter (something related with phyllip file)
- [ ] Change the output of get.node.range_BioGeoBEARS to keep only internal nodes
